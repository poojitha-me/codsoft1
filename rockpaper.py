...
def reset():
   ...
   label.config(text = "")
labelframe= LabelFrame(win, text= "Rock Paper Scissor", font= ('Tahoma'),labelanchor= "n",bd=5,bg= "cyan",width= 600, height= 450, cursor= "target")
labelframe.pack(expand= True, fill= BOTH)
l1= Label(labelframe, text="Player", font= ('Helvetica 18 bold'))
l1.place(relx= .18, rely= .1)
l2= Label(labelframe, text="VS", font= ('Helvetica 18 bold'), bg="sea green")
l2.place(relx= .45, rely= .1)
l3= Label(labelframe, text="Computer", font= ('Helvetica 18 bold'))
l3.place(relx= .65, rely= .1)
label= Label(labelframe, text="", font=('Coveat', 25,'bold'), bg= "plum")
label.pack(pady=150)
...
reset= Button(labelframe, text= "Reset",bg= "YellowGreen", fg= "Black",width= 7, font= 10, command= reset)
